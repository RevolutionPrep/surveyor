Surveyor::Application.routes.draw do
  ...
  resources :sections, :except => [:index, :new, :create] do
    member do
      get 'confirm_delete'
    end
  ...
  resources :rating_scales do
    member do
      get 'confirm_delete'
    end
    resources :rating_labels, :only => [:index, :new, :create]
  end

  resources :rating_labels, :except => [:index, :new, :create] do
    member do
      get 'confirm_delete'
    end
  end
